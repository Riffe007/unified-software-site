...
export default function HeroSection() {
  ...
  return (
    <section
      className={`relative h-screen flex flex-col justify-center items-center text-center transition-all duration-500
      ${theme === "dark" 
    ...
    >
      ...
      >
        ...
        <Link href="/contact" className="px-6 py-3 border border-blue-900 rounded-md text-lg font-medium transition hover:bg-blue-900 hover:text-white">
          Contact Us
        </Link>
      </motion.div>
    </section>
